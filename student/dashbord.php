    ...
    <svg style="display:none;">
      <!-- the arrow od the menue collapse  -->
    <symbol id="down" viewBox="0 0 16 16">
      ...
      <!-- the arrow od the menue settings  -->
      <symbol id="settings" viewBox="0 0 16 16">
        ...
        <!-- the arrow od the menue options  -->
    ...
    <header class="page-header">
      ...
      <nav class="nav2"><b>
        <a class="a" href="#0">
          <h3>Welcome  <span style='color: #ffcf76'><?echo $studentname."&nbsp";
                                                      echo $studentLname."<br>";
                                                      echo "ID :". $student_Id;?></span></h3>
        </a></b>
        ...
        <ul class="admin-menu">
          ...
          <li>
            <a class="a" href="stu_profile.php">
              <svg>
          ...
          <li>
            <a class="a" href="stu_chngpass.php">
              <svg>
          ...
          <li>
            <a class="a" href="stu_PassRecovery.php">
              <svg>
